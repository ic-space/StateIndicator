...
The main purpose of this driver is to provide us with indications of different events, for example on system start up. This is done with an LED and buzzer which is built into our dev boards.
